...
- Worker run log: `board-resolver: auto-bound notion-infra → 000000000000000014, saved-instagram-curator → 000000000000000016, vta-rng → 000000000000000020` (proves runtime resolver working)
