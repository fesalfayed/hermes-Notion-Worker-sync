...
```bash
ntn workers exec renameProjectChannel --input '{"discord_channel_id":"000000000000000014","new_name":"hermes-projects-sync"}'
```
...
```bash
ntn workers exec archiveProject --input '{"discord_channel_id":"000000000000000014"}'
```
...
```bash
ntn workers exec unarchiveProject --input '{"discord_channel_id":"000000000000000014"}'
```
...
```bash
ntn workers exec rebindByChannelId --input '{"discord_channel_id":"000000000000000014"}'
```
...
```bash
ntn workers exec bindProjectToBoard --input '{"discord_channel_id":"000000000000000014","board_slug":"hermes-projects-sync"}'
```
