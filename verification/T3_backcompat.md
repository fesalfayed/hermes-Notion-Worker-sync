...
{
  "boardToChannel": {"hermes-projects-sync": "000000000000000014"},
  "channelToBoard": {"000000000000000014": "hermes-projects-sync"}
}
```

**Result: PASS** — `hermes-projects-sync` → `000000000000000014` (identical to pre-change)
...
{
  "results": [
    {"slug": "hermes-projects-sync", "channel_id": "000000000000000014", "ok": true}
  ]
}
```
...
is transparent — `hermes-projects-sync` resolves to `000000000000000014`
